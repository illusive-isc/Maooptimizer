...
{
    [AddComponentMenu("")]
    internal class IllMaoParam8bit : IllMaoParam
    {
        VRCAvatarDescriptor descriptor;
        AnimatorController animator;

        private static readonly List<string> MenuParameters = new() { "8bit" };

        public IllMaoParam8bit Initialize(
            VRCAvatarDescriptor descriptor,
            AnimatorController animator
        )
        {
        ...
        public IllMaoParam8bit DeleteParam()
        {
        ...
        public IllMaoParam8bit DeleteFxBT()
        {
        ...
        public IllMaoParam8bit DeleteVRCExpressions(
