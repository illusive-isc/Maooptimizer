...
{
    [AddComponentMenu("")]
    internal class IllMaoParamHeartGun : IllMaoParam
    {
        ...
        public IllMaoParamHeartGun Initialize(
            VRCAvatarDescriptor descriptor,
            AnimatorController animator
        )
        {
        ...
        public IllMaoParamHeartGun DeleteFx()
        {
            foreach (
        ...
        public IllMaoParamHeartGun DeleteParam()
        {
        ...
        public IllMaoParamHeartGun DeleteFxBT()
        {
                ...
                foreach (var state in layer.stateMachine.states)
                {
                    if (state.state.motion is BlendTree blendTree)
                    {
                        blendTree.children = blendTree
                            .children.Where(c => !(c.motion.name == "HeartGun"))
                            .ToArray();
                    }
                }
            }
        ...
        public IllMaoParamHeartGun DeleteVRCExpressions(
