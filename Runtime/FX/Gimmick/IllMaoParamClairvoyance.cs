...
{
    [AddComponentMenu("")]
    internal class IllMaoParamClairvoyance : IllMaoParam
    {
        VRCAvatarDescriptor descriptor;
        AnimatorController animator;

        private static readonly List<string> MenuParameters = new() { "clairvoyance" };

        public IllMaoParamClairvoyance Initialize(
            VRCAvatarDescriptor descriptor,
            AnimatorController animator
        )
        {
        ...
        public IllMaoParamClairvoyance DeleteParam()
        {
        ...
        public IllMaoParamClairvoyance DeleteFxBT()
        {
        ...
        public IllMaoParamClairvoyance DeleteVRCExpressions(
                ...
                if (control.name == "Gimmick")
                {
                    ...
                    foreach (var control2 in expressionsSubMenu.controls)
                    {
                        if (control2.name == "camera")
                        {
                            ...
                            {
                                if (control3.name is "Clairvoyance")
                                {
